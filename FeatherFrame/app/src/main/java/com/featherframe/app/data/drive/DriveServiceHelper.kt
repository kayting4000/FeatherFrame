package com.featherframe.app.data.drive
...
class DriveServiceHelper(private val context: Context) {
    ...
    companion object {
        private const val APPLICATION_NAME = "FeatherFrame"
        private const val RAW_MIME_TYPE = "image/x-adobe-dng"
        private const val JPEG_MIME_TYPE = "image/jpeg"
        private const val FOLDER_MIME_TYPE = "application/vnd.google-apps.folder"
        private const val ORNITRACK_FOLDER_NAME = "FeatherFrame_Captures"
    }
     ...
     */
    suspend fun initialize(googleAuthHelper: com.featherframe.app.domain.auth.GoogleAuthHelper): Boolean = withContext(Dispatchers.IO) {
        try {
