...
import com.ornitrack.raw.domain.auth.SessionManager
import com.ornitrack.raw.domain.auth.GoogleAuthHelper
import com.ornitrack.raw.data.processing.ImageProcessor
import com.ornitrack.raw.ui.screens.*
import com.ornitrack.raw.ui.workers.SyncUploadWorker
import java.io.File

/**
 * MainActivity — Entry point for OrniTrack RAW.
 ...
 */
@Composable
fun OrniTrackTheme(content: @Composable () -> Unit) {
        ...
        NavHost(
            ...
            composable(Screen.NewsFeed.route) {
                val captureFlow = remember {
                    OrniTrackApp.instance.database
                        .birdCaptureDao()
                        .getAllCaptures()
                }
