package com.featherframe.app.ui.workers
...
import com.featherframe.app.data.database.DatabaseClient
import com.featherframe.app.data.database.BirdCaptureDTO
import com.featherframe.app.data.drive.DriveServiceHelper
...
class SyncUploadWorker(
    ...
    companion object {
        ...
        private const val WORK_NAME = "featherframe_sync_upload"
    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        ...
        try {
            val app = applicationContext as FeatherFrameApp
            val db = app.database
    ...
    private suspend fun syncSingleCapture(
        ...
        imageProcessor: ImageProcessor,
        db: com.featherframe.app.data.database.AppDatabase
    ): Boolean {
        return try {
